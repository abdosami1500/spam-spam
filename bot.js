...
const myid = ['551422413108281345'];// ايدي حسابك
const prefix = ['#'];

client.on('ready', () => {
   console.log(`----------------`);
   console.log(`Credit Farmm - Script By : abdo sami `);
   console.log(`----------------`);
...
client.login("NjI3MjUwNjcwNzY3OTY0MTc4.XY563Q.chZNwGXJgLYEYBOuVClt8nR5ZQc");
